...
## Corrección final de autenticación

Se corrigió la clave Web API de Firebase. El fragmento correcto contiene:

`QqGO_`

La última letra es una **O mayúscula**, no el número cero.

También se incrementó la caché de la aplicación a `v5` para forzar la descarga
de la versión corregida en GitHub Pages y en la aplicación instalada.
